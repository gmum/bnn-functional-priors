""" Piecewise linear activation from: https://github.com/PiotrDabkowski/torchpwl/blob/master/torchpwl/pwl.py """
import torch
...
class PWLLearnableActivation(nn.Module):
    ...
    def __init__(
        ...
        self.num_breakpoints = num_breakpoints
        self.pwl = PWL(
            num_channels=self.num_channels, num_breakpoints=self.num_breakpoints
        )
